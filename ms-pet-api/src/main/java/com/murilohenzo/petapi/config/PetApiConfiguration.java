...
import com.murilohenzo.petapi.adapters.outbound.persistence.impl.UserRefPersistencePortImpl;
...
public class PetApiConfiguration {
  ...
  @Bean
  public PetServicePortImpl petService(PetPersistencePort petPersistencePort, UserRefPersistencePort userRefPersistencePort) {
    return new PetServicePortImpl(petPersistencePort, userRefPersistencePort);
  }
  ...
  @Bean
  public PetPhotoPersistencePortImpl petPhotoRepository(PetPhotoJpaRepository petPhotoRepository, PetPhotoMapper petPhotoMapper) {
    return new PetPhotoPersistencePortImpl(petPhotoRepository, petPhotoMapper);
  }
  
  @Bean
  public UserRefPersistencePortImpl userRefPersistencePort(UserRefJpaRepository userRefJpaRepository) {
    return new UserRefPersistencePortImpl(userRefJpaRepository);
  }
